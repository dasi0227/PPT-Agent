...
> 后续决定：[HTML 生成参考快照与变化上下文](2026-09-25-html-generation-reference-snapshots-design.md) 将 html_state 统一为 missing / available，页面引用显示“幻灯片未生成／已生成”，取消物化过期态和“待更新”；设计稿状态继续独立。
