...
describe('threadStore v6', () => {
  ...
  it('deleteThread DELETEs and cleans up, switching neighbor', async () => {
    ...
    useRunStore.setState({
      sessions: { t2: { activeRunId: null, status: 'idle', target: { artifact: 'presentation', level: 'slide' }, interaction: { intent: 'execute' }, timelineItems: [], pendingQuestion: null, progress: null, eventSourceClose: null, plan: null } },
    });
