...
>(({ className, overlayClassName, children, onEscapeKeyDown, onCloseAutoFocus, ...props }, ref) => {
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "text-lg font-semibold leading-none tracking-tight text-text-900",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn("text-sm text-text-400", className)}
    {...props}
  />
))
