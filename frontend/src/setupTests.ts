  ...
  if (url.includes('/projects')) {
    if (url.includes('/content')) {
      const body = {
        ...
        design: { version: '4.0', revision: 1, project_id: 'p1', theme: 'clean', direction: 'minimal', chrome: [{ type: 'page_number', placement: 'bottom-right', style: 'muted' }], created_at: 0, updated_at: 0 },
