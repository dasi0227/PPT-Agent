...
describe('ThreadTabs selection', () => {
  it('switches threads by click and exposes selected tab state', () => {
    ...
    useThreadStore.setState({
      threadsByProjectId: {
        p1: [
          { id: 't1', project_id: 'p1', title: '会话一', created_at: 1, updated_at: 1, auto_rename_enabled: true, naming_revision: 1 },
          { id: 't2', project_id: 'p1', title: '会话二', created_at: 1, updated_at: 1, auto_rename_enabled: true, naming_revision: 1 },
        ],
      },
...
describe('ThreadTabs create thread', () => {
  it('creates a new thread when the plus button is clicked', async () => {
    ...
    useThreadStore.setState({
      threadsByProjectId: {
        p1: [{ id: 't1', project_id: 'p1', title: '会话一', created_at: 1, updated_at: 1, auto_rename_enabled: true, naming_revision: 1 }],
      },
