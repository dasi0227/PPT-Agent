...
- Final answer: the finish message must describe the actual completed result, not internal reasoning or a vague status.

If evidence is missing or stale, reject unless the task is read-only and the final answer only provides a plan or analysis.
