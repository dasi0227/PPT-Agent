...
- Relevant, exact file/page/resource references and what to consult them for. Include the essential decision in the prompt itself; a reference alone is not a task definition.
...
- Use only supplied references. Preserve relevant page titles/stable IDs and image/selection identities with their purpose; do not invent paths, assets or claim visual inspection. Direct the receiving Agent to consult relevant current resources where needed, without copying their full contents.
