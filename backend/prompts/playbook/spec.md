...
- Keep semantic intent consistent with the requested page result. When content changes invalidate existing HTML, update the affected output based on the actual reference differences and task. A visual-only adjustment need not rewrite an unchanged Spec.
