...
- Slide HTML is the Agent-authored page body. Runtime owns the frame, equal-ratio fitting, shared decorations and derived numbering. Materialization records and render proof are Runtime-managed, never author-written.
