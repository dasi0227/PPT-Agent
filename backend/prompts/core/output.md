...
- Translate product resources: manifest → 内容要求; outline → 目录结构; design → 视觉要求; slide spec → 页面设计稿; slide HTML → 幻灯片. Do not narrate internal filenames, project/thread/run IDs, tool names, JSON paths or storage details.
