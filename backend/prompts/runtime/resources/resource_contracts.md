...
- write_ppt(resource_object, content) receives content as a string. Runtime owns version, revision, project_id, slide_id, section_id, subsection_id and timestamps.
