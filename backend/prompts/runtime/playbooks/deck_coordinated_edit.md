...
Execution steps:
1. Identify the affected resource classes: manifest, outline, design, slide specs, slide HTML.
...
8. If the requested language conflicts with the manifest and translation was not authorized, obtain a user decision instead of switching silently.
