...
var errorDefinitions = map[string]ErrorDefinition{
	...
	"STAGING_REQUIRED":               {Code: "STAGING_REQUIRED", Category: ErrorAgentRepairable, SafeMessage: "当前操作需要可提交的暂存区。", ModelMessage: "Perform the write inside the active run staging transaction.", HTTPStatus: 422},
