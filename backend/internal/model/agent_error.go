...
var errorDefinitions = map[string]ErrorDefinition{
	...
	"BRIEFING_ACTIVE":                {Code: "BRIEFING_ACTIVE", Category: ErrorConflict, SafeMessage: "项目有其他操作正在进行，请稍后重试。", ModelMessage: "Wait for the active project operation to finish.", Retryable: true, HTTPStatus: 409},
