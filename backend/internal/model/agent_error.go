...
var errorDefinitions = map[string]ErrorDefinition{
	...
	"RESOURCE_INVALID":               {Code: "RESOURCE_INVALID", Category: ErrorAgentRepairable, SafeMessage: "PPT 资源地址不合法。", ModelMessage: `resource must be an object, not a string or path. Use {"type":"deck","part":"outline"}, {"type":"deck","part":"design"}, or {"type":"slide","slide_id":"<stable slide_id>","part":"spec|html"}. Never use "deck:outline", "slide:<id>:html", "current", or "slides/...".`, HTTPStatus: 422},
